...
git status
git add .
git commit -m "Release ARK Router v0.9.27"
git push origin main
git tag -a v0.9.27 -m "ARK Router v0.9.27"
...
```text
https://github.com/Despensativo/ark-router/releases/tag/v0.9.27
```
