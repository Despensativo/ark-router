...
4. Create and push a version tag matching `VERSION`, such as `v0.9.42`.
...
git status
git add .
git commit -m "Release ARK Router v0.9.42"
git push origin main
git tag -a v0.9.42 -m "ARK Router v0.9.42"
git push origin v0.9.42
```
...
```text
https://github.com/Despensativo/ark-router/releases/tag/v0.9.42
```
