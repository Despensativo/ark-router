...
git status
git add .
git commit -m "Release ARK Router v0.9.25"
git push origin main
git tag -a v0.9.25 -m "ARK Router v0.9.25"
...
```text
https://github.com/Despensativo/ark-router/releases/tag/v0.9.25
```
