	...
	showEzSetup: function(){
		return this.loadEzSetup().then(L.bind(function(saved){
			...
			ui.showModal('Ark - Setup',[E('div',{class:'ex-ez-setup'},[
				...
				E('section',{},[E('h3',{},['7. Recursos sugeridos']),E('p',{class:'ex-muted'},['O Ark - Setup salva a intenção. Instalações de módulos continuam exigindo confirmação pelo centro de recursos.']),moduleList]),
