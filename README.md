...
![Release](https://img.shields.io/badge/release-v0.9.90-blue.svg)
...
The current official release is **v0.9.90**. ARK Router is an add-on package (`luci-app-ark-router`), not a replacement firmware image or ISO.
